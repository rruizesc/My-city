...
object LocalCityDataProvider {
    val defaultCity: City by lazy { getCityData().firstOrNull() ?: City(0, 0, 0, 0, emptyList()) }
    val defaultSubCity: SubCity by lazy { getSubCitiesBySelectedCategory().firstOrNull() ?: SubCity(0, 0, 0, 0, 0) }
            ...
            City(
                ...
                categories = listOf(
                    SubCityCategory(
                        ...
                        subCities = getSubCitiesBySelectedCategory()
                    )
                )
            ),
            City(
    ...
    fun getSubCitiesBySelectedCategory(): List<SubCity> {
        return when (0) {
            1 -> getSubCityDataForParques()
            2 -> getSubCityDataForCentros()
            3 -> getSubCityDataForLugaresAptos()
            4 -> getSubCityDataForRestaurantes()
            else -> emptyList()
        }
    }


    private fun getSubCityDataForParques(): List<SubCity> {
        return listOf(
            SubCity(
                id = 1,
    ...
    private fun getSubCityDataForCentros(): List<SubCity> {
        return listOf(
            SubCity(
                id = 1,
    ...
    private fun getSubCityDataForLugaresAptos(): List<SubCity> {
        return listOf(
            SubCity(
                id = 1,
    ...
    private fun getSubCityDataForRestaurantes(): List<SubCity> {
        return listOf(
            SubCity(
                id = 1,

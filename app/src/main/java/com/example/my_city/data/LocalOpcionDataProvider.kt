...
object LocalOpcionDataProvider {
    fun getOpcionDataForParques(): List<Opcion> {
        return listOf(
            Opcion(
                id = 1,
    ...
    fun getOpcionDataForCentros(): List<Opcion> {
        return listOf(
            Opcion(
                id = 1,
    ...
    fun getOpcionDataForLugaresAptos(): List<Opcion> {
        return listOf(
            Opcion(
                id = 1,
    ...
    fun getOpcionDataForRestaurantes(): List<Opcion> {
        return listOf(
            Opcion(
                id = 1,
